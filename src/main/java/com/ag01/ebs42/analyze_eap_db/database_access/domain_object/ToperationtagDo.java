...
public class ToperationtagDo implements Serializable {
    ...
    public ToperationtagDo() {
        super();
    }

    public ToperationtagDo(int propertyid, int elementid, String property, String value, String notes, String eaguid) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ToperationtagDo other = (ToperationtagDo) obj;
    ...
    public String toString() {
        return "Toperationtag [ " + " propertyid=" + propertyid + " elementid=" + elementid + " property=" + property + " value=" + value + " notes=" + notes + " eaguid=" + eaguid+ "]";
    }
