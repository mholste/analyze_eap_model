...
public class TxrefsystemDo implements Serializable {
    ...
    public TxrefsystemDo() {
        super();
    }

    public TxrefsystemDo(String xrefid, String name, String type, String visibility, String namespace, String requirement, String constraint, String behavior, String partition, String description, String client, String supplier, String link, String toolid) {
        super();
        this.xrefid = xrefid;
        this.name = name;
        this.type = type;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TxrefsystemDo other = (TxrefsystemDo) obj;
        if(xrefid == null) {
    ...
    public String toString() {
        return "Txrefsystem [ " + " xrefid=" + xrefid + " name=" + name + " type=" + type + " visibility=" + visibility + " namespace=" + namespace + " requirement=" + requirement + " constraint=" + constraint + " behavior=" + behavior + " partition=" + partition + " description=" + description + " client=" + client + " supplier=" + supplier + " link=" + link + " toolid=" + toolid+ "]";
    }
