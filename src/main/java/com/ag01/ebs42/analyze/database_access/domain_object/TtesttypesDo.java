...
public class TtesttypesDo implements Serializable {
    ...
    public TtesttypesDo(String testtype, String description, long numericweight, String notes) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TtesttypesDo other = (TtesttypesDo) obj;
        if(testtype == null) {
    ...
    public String toString() {
        return "Ttesttypes [ " + " testtype=" + testtype + " description=" + description + " numericweight=" + numericweight + " notes=" + notes+ "]";
    }
