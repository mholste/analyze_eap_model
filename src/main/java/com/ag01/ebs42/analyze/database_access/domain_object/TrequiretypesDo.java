...
public class TrequiretypesDo implements Serializable {
    ...
    public TrequiretypesDo() {
        super();
    }

    public TrequiretypesDo(String requirement, String description, long numericweight, String notes) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TrequiretypesDo other = (TrequiretypesDo) obj;
        if(requirement == null) {
    ...
    public String toString() {
        return "Trequiretypes [ " + " requirement=" + requirement + " description=" + description + " numericweight=" + numericweight + " notes=" + notes+ "]";
    }
