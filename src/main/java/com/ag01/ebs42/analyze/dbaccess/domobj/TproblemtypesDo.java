...
public class TproblemtypesDo implements Serializable {
    ...
    public TproblemtypesDo() {
        super();
    }

    public TproblemtypesDo(String problemtype, String description, long numericweight, String notes) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TproblemtypesDo other = (TproblemtypesDo) obj;
        if(problemtype == null) {
    ...
    public String toString() {
        return "Tproblemtypes [ " + " problemtype=" + problemtype + " description=" + description + " numericweight=" + numericweight + " notes=" + notes+ "]";
    }
